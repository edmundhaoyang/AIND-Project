...
from game_agent import custom_score, linear_combination_moves_score, moves_and_position_opposite, moves_and_position,linear_combination_moves_score_opposite, cutoff_heuristics
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
                    Agent(CustomPlayer(score_fn=linear_combination_moves_score, **CUSTOM_ARGS), "Student_1"),
                    Agent(CustomPlayer(score_fn=moves_and_position, **CUSTOM_ARGS), "Student_2"),
                    Agent(CustomPlayer(score_fn=moves_and_position_opposite, **CUSTOM_ARGS), "Student_3"),
                    Agent(CustomPlayer(score_fn=linear_combination_moves_score_opposite, **CUSTOM_ARGS), "Student_4"),
                    Agent(CustomPlayer(score_fn=cutoff_heuristics, **CUSTOM_ARGS), "Student_5")
                    ]
