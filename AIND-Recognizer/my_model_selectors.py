    ...
    def select(self):
        ...
        try:
            ...
            for component in range(self.min_n_components, self.max_n_components+1):
                ...
                p = component **2 + 2* features*component - 1
    ...
    def select(self):
        ...
        try:
            ...
            for n_component in range(self.min_n_components, self.max_n_components+1):
                ...
                score_dic = model.score(self.X, self.lengths) - np.mean(scores)
                if score_dic > topScore:
                    topScore = score_dic
                    topModel = model
            return topModel   
    ...
    def select(self):
        ...
        for components in range(self.min_n_components, self.max_n_components + 1):
            ...
            for cv_train_idx, cv_test_idx in split_method.split(self.sequences):
                ...
                try:
                    model = GaussianHMM(n_components=components, covariance_type="diag", n_iter=1000,
            ...
            averag = np.average(scores) if len(scores) > 0 else float("-inf")
